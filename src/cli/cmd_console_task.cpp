...
static const CLI_Command_Definition_t xPingCommand =
    {
        "ping",
        "ping <message>:\n Replies pong with the message entered\n",
        prvPingCommand,
        1};
...
void vCommandConsoleTask(void *pvParameters)
{
    ...
    static char pcOutputString[FREERTOS_CLI_MAX_OUTPUT_LENGTH], pcInputString[FREERTOS_CLI_MAX_INPUT_LENGTH];
        ...
        if (cRxedChar == '\n')
        {
            ...
            do
            {
                ...
                xMoreDataToFollow = FreeRTOS_CLIProcessCommand(
                    ...
                    FREERTOS_CLI_MAX_OUTPUT_LENGTH /* The size of the output buffer. */
                );
            ...
            cInputIndex = 0;
            memset(pcInputString, 0x00, FREERTOS_CLI_MAX_INPUT_LENGTH);
        }
        else
        {
            ...
            else
            {
                ...
                if (cInputIndex < FREERTOS_CLI_MAX_INPUT_LENGTH)
                {
