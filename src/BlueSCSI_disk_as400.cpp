...
extern "C" void as400_get_serial_8(uint8_t scsi_id, uint8_t *serial_buf)
{
    ...
    serial_buf[0] = hex_letters[board_id.id[5] & 0xF];
    serial_buf[1] = hex_letters[board_id.id[4] & 0xF];
    serial_buf[2] = hex_letters[board_id.id[3] & 0xF];
    serial_buf[3] = hex_letters[board_id.id[2] & 0xF];
    serial_buf[4] = hex_letters[board_id.id[1] & 0xF];
    serial_buf[5] = hex_letters[(board_id.id[0] ^ scsi_id) & 0xF];
