...
uint8_t MscExampleDisk::msc_disk0[MscExampleDisk::DISK_BLOCK_NUM][MscExampleDisk::DISK_BLOCK_SIZE] =
{
  //------------- Block0: Boot Sector -------------//
...
uint8_t MscExampleDisk::msc_disk1[MscExampleDisk::DISK_BLOCK_NUM][MscExampleDisk::DISK_BLOCK_SIZE] =
{
  //------------- Block0: Boot Sector -------------//
  // byte_per_sector    = DISK_BLOCK_SIZE; fat12_sector_num_16  = DISK_BLOCK_NUM;
  // sector_per_cluster = 1; reserved_sectors = 1;
