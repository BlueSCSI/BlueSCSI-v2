...
void build_device_descriptor(){
    ...
    save_descriptor("generated_device_descriptor", dd.getDescriptorBlock(), dd.getDescriptorBlockLength());
}
...
void check_configuration_descriptors(){
    ...
    cd_config->setConfigurationValue(0);
...
void build_cdc_interface(USB::ConfigurationDescriptor *cfg_desc){
    ...
    cfg_desc->addInterface(iface_associate);
    ...
    cfg_desc->addInterface(union_desc);
    ...
    union_desc->addEndpoint(ep_notif);
    ...
    cfg_desc->addInterface(iface_data);
